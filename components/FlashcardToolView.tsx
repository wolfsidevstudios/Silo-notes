...
const FlashcardToolView: React.FC<FlashcardToolViewProps> = ({ onBack }) => {
  ...
  return (
    <div className={commonViewClasses}>
      <header className="mb-10 flex-shrink-0">
        ...
        <h1 className="text-4xl font-bold text-gray-900">Notes to Flashcards</h1>
        <p className="text-lg text-gray-500 mt-2">Paste your notes below to automatically create study cards.</p>
      </header>
