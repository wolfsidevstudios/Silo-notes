...
interface JamBoardViewProps {
  board: Board;
  space: Space;
  onBack: () => void;
}

const JamBoardView: React.FC<JamBoardViewProps> = ({ board, space, onBack }) => {
  return (
    <div className="p-8 lg:p-12 h-full flex flex-col">
      <header className="mb-10">
        ...
        <p className="text-lg text-gray-500 mt-2">Jam Board - Content will go here.</p>
      </header>
      <div className="flex-grow flex items-center justify-center text-center bg-gray-50 rounded-lg border-2 border-dashed">
        <div>
          ...
          <p className="text-gray-500 mt-2">This is where your collaborative jam board will live.</p>
        </div>
      </div>
    </div>
  );
